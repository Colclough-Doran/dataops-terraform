...
resource "aws_vpc_security_group_egress_rule" "allow_docker_5000" {
  security_group_id = aws_security_group.this.id
  cidr_ipv4         = var.vpc_cidr_block
  ip_protocol       = "tcp"
  from_port         = 5000
...
resource "aws_vpc_security_group_egress_rule" "allow_jenkins_8080" {
  security_group_id = aws_security_group.this.id
  cidr_ipv4         = var.vpc_cidr_block
  ip_protocol       = "tcp"
  from_port         = 8080
...
resource "aws_vpc_security_group_ingress_rule" "allow_docker_5000" {
  security_group_id = aws_security_group.this.id
  cidr_ipv4         = var.vpc_cidr_block
  ip_protocol       = "tcp"
  from_port         = 5000
...
resource "aws_vpc_security_group_ingress_rule" "allow_jenkins_8080" {
  security_group_id = aws_security_group.this.id
  cidr_ipv4         = var.vpc_cidr_block
  ip_protocol       = "tcp"
  from_port         = 8080
